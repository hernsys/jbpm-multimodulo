...
2) you must import the files *.bpmn2 in a new proyect in "jbpm console NG" after that you should 
to generate all forms

3) Copy the jbpm-services *jar into the jbpm-console.war/WEB-INF/lib directory 

4) Configure the handlers in WEB-INF/classes/META-INF/CustomWorkItemHandlers.conf
